...
道路是唯一强视觉签名，三条道路永久映射恢复、工作、生活；Tab 是主要切换器，道路也可点击并与 Tab 同步。主线槽独立位于道路下方，不覆盖道路。视觉保持浅色、低饱和、晨雾灰蓝；三状态不使用三套强主题色。第一屏宁可少露半截 Todo，也不能把三岔大道压成横幅；道路必须先让人产生「我站在这里，前面有三条路」的空间感，再承接 Current 与 Priority。
